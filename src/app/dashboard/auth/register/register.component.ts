...
export class RegisterComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.watchIndicator = this.indc.currentRStatus.subscribe((value) => {
      // console.log("IndicatorService (debit-card-details): value", value);
  ...
  async preRegister() {
    ...
    if (this.selectedData != null) {
      ...
      if (snString !== '' && anArray !== []) {
        ...
        // console.log("SKYVAULT: Generated Card Data :",ccCardData);
  ...
  prepareCard(cardNumber, cardGenerated, cvv, pans, snString, nnString): void {
    ...
    this.addTextToImage('assets/images/card.png', this.cardData, this.registerParams, this.doRegister);
  }

  async doRegister(me, registerParams) {
    me.progressMessage = 'Creating SkyVault Account..';
    // console.log("SKYVAULT: creating skyvault acc...", registerParams);
    try {
      let registerResponse = await me.skyvault.register(registerParams);
      // console.log("SKYVAULT: registerResponse",registerResponse);
  ...
  getCardData(sn) {
    ...
    // console.log("Skyvault: getCardData: ", grv);
